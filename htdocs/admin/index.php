...
<body>
	<?php
		...
		*/
		...
		echo '<form action="addRemovePost.php" method="post" ><input type="hidden" id="postToRemove" name="postId" value="-1"/><input type="submit" value="remove this post"></input></form>';
